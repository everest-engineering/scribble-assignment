    ...
    <section className="panel placeholder-page">
      ...
      <div className="summary-grid">
        ...
        <Card title="Status">
          ...
          <p style={{ marginTop: '8px' }}>
            {error ?? refreshError ?? (isHost 
              ? (room.participants.length < 2 ? "Waiting for at least 2 players to join." : "You can now start the game.")
      ...
      <div className="button-row button-row--spread">
        ...
        {isHost ? (
          ...
          <button className="button button--primary" disabled title="Only the host can start the game">
            Waiting for Host...
          </button>
        )}
      </div>
